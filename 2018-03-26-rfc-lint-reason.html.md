...
has anyone ever asked for something like #[expect(lint)] which would basically
be like #[allow(lint)] but give you a lint warning if the problem ever went
away?
<br>
<br>
I basically want to mark things as ok while doing initial work, but I need to
know when safe to remove</p>— Yehuda Katz (@wycats)
<a href="https://twitter.com/wycats/status/979742693378019329">
March 30, 2018
</a>
</blockquote>
